...
6. Remove the H3 element Libraries for inside the padded ordered list element and put it outside si it can be nproperly centered with the other H3 elements.
